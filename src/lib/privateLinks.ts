...
import { extractSha256FromUrl } from "./blossomClient";
...
type NdkSignerInstance = NdkContextValue["signer"];
type NdkUserInstance = NdkContextValue["user"];
