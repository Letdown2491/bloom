...
// node_modules/.pnpm/typescript-lru-cache@2.0.0/node_modules/typescript-lru-cache/dist/LRUCacheNode.js
var require_LRUCacheNode = __commonJS({
  "node_modules/.pnpm/typescript-lru-cache@2.0.0/node_modules/typescript-lru-cache/dist/LRUCacheNode.js"(exports) {
    "use strict";
...
// node_modules/.pnpm/typescript-lru-cache@2.0.0/node_modules/typescript-lru-cache/dist/LRUCache.js
var require_LRUCache = __commonJS({
  "node_modules/.pnpm/typescript-lru-cache@2.0.0/node_modules/typescript-lru-cache/dist/LRUCache.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/.pnpm/typescript-lru-cache@2.0.0/node_modules/typescript-lru-cache/dist/index.js
var require_dist = __commonJS({
  "node_modules/.pnpm/typescript-lru-cache@2.0.0/node_modules/typescript-lru-cache/dist/index.js"(exports) {
    "use strict";
...
var require_lib = __commonJS({
  "node_modules/.pnpm/@scure+base@1.1.1/node_modules/@scure/base/lib/index.js"(exports) {
    ...
    exports.base32crockford = chain3(radix23(5), alphabet3("0123456789ABCDEFGHJKMNPQRSTVWXYZ"), join3(""), normalize4((s) => s.toUpperCase().replace(/O/g, "0").replace(/[IL]/g, "1")));
    ...
    var base58check = (sha2565) => chain3(checksum(4, (data) => sha2565(sha2565(data))), exports.base58);
    ...
    exports.hex = chain3(radix23(4), alphabet3("0123456789abcdef"), join3(""), normalize4((s) => {
...
// src/lib/tseep.ts
var warnMaxListeners = (count, max, event) => {
...
var EventEmitter = class {
  constructor() {
    __publicField(this, "maxListeners", Infinity);
    __publicField(this, "registry", /* @__PURE__ */ new Map());
    __publicField(this, "boundRefs");
  }
  emit(event, ...args) {
    const store = this.registry.get(event);
    if (!store || store.length === 0) return false;
    const entries = [...store];
    for (const entry of entries) {
      if (entry.once) {
        this.removeListener(event, entry.wrapped);
      }
      entry.wrapped.apply(this, args);
    }
    return true;
  }
  on(event, listener) {
  ...
  removeListener(event, listener) {
    ...
    if (idx !== -1) {
      store.splice(idx, 1);
      if (store.length === 0) this.registry.delete(event);
    }
    return this;
  }
  off(event, listener) {
  ...
  listeners(event) {
    ...
    if (!store) return [];
    return store.map(
      (entry) => entry.once ? entry.wrapped : entry.original
    );
  }
  rawListeners(event) {
    const store = this.registry.get(event);
    if (!store) return [];
    return store.map((entry) => entry.wrapped);
  }
  eventNames() {
  ...
  addListenerBound(event, listener, bindTo = this) {
    ...
    this.boundRefs ?? (this.boundRefs = /* @__PURE__ */ new WeakMap());
    this.boundRefs.set(listener, bound);
    return this.addListener(event, bound);
  }
  removeListenerBound(event, listener) {
    var _a25, _b;
    const bound = (_a25 = this.boundRefs) == null ? void 0 : _a25.get(listener);
    if (bound) {
      (_b = this.boundRefs) == null ? void 0 : _b.delete(listener);
      return this.removeListener(event, bound);
    }
    return this.removeListener(event, listener);
  }
  addEntry(event, listener, once, prepend) {
    const store = this.ensureStore(event);
    const original = listener;
    const wrapped = once ? this.createOnceWrapper(event, original) : original;
    const entry = { original, wrapped, once };
    if (prepend) store.unshift(entry);
    else store.push(entry);
    warnMaxListeners(store.length, this.maxListeners, event);
    return this;
  }
  ensureStore(event) {
...
// node_modules/.pnpm/@nostr-dev-kit+ndk@2.14.35_nostr-tools@2.16.2_typescript@5.9.2_/node_modules/@nostr-dev-kit/ndk/dist/index.mjs
...
function weierstrass(curveDef) {
  ...
  function verify(signature, msgHash, publicKey, opts = defaultVerOpts) {
    ...
    const u1 = modN2(h * is);
    const u2 = modN2(r * is);
    const R = (_a25 = Point2.BASE.multiplyAndAddUnsafe(P, u1, u2)) == null ? void 0 : _a25.toAffine();
    if (!R)
      return false;
    const v = modN2(R.x);
    return v === r;
...
// node_modules/.pnpm/nostr-tools@2.16.2_typescript@5.9.2/node_modules/nostr-tools/lib/esm/index.js
...
function decode(code) {
  var _a25, _b, _c, _d, _e, _f, _g;
  let { prefix, words } = bech32.decode(code, Bech32MaxSize);
  let data = new Uint8Array(bech32.fromWords(words));
  switch (prefix) {
    case "nprofile": {
      let tlv = parseTLV(data);
      if (!((_a25 = tlv[0]) == null ? void 0 : _a25[0]))
...
async function queryProfile(fullname) {
  ...
  try {
    ...
    return pubkey ? { pubkey, relays: (_a25 = json.relays) == null ? void 0 : _a25[pubkey] } : null;
  } catch (_e) {
    return null;
  }
}
    ...
    if (ref.author) {
      ...
      if (author && author.relays) {
        ...
        author.relays.forEach((url) => {
          var _a25;
          if (((_a25 = ref.relays) == null ? void 0 : _a25.indexOf(url)) === -1)
            ref.relays.push(url);
        });
  ...
  return finalizeEvent(
    {
      kind,
      tags,
      content: t.content === "" || ((_a25 = reposted.tags) == null ? void 0 : _a25.find((tag) => tag[0] === "-")) ? "" : JSON.stringify(reposted),
...
function Field2(ORDER, bitLenOrOpts, isLE5 = false, opts = {}) {
  if (ORDER <= _0n7)
  ...
  const f = Object.freeze({
    ...
    fromBytes: (bytes4, skipValidation = true) => {
      if (allowedLengths) {
        ...
        padded.set(bytes4, isLE5 ? 0 : padded.length - bytes4.length);
        bytes4 = padded;
      }
      if (bytes4.length !== BYTES)
        throw new Error("Field.fromBytes: expected " + BYTES + " bytes, got " + bytes4.length);
      let scalar = isLE5 ? bytesToNumberLE2(bytes4) : bytesToNumberBE2(bytes4);
      if (modFromBytes)
...
function createField(order, field, isLE5) {
  if (field) {
    ...
    return Field2(order, { isLE: isLE5 });
  }
}
...
function weierstrassN(params, extraOpts = {}) {
  ...
  class Point2 {
    ...
    static fromHex(hex3) {
      return Point2.fromBytes(ensureBytes2("pointHex", hex3));
    }
    get x() {
      return this.toAffine().x;
    }
...
function mapToCurveSimpleSWU2(Fp2, opts) {
  ...
  if (!Fp2.isValid(A) || !Fp2.isValid(B) || !Fp2.isValid(Z))
    throw new Error("mapToCurveSimpleSWU: invalid opts");
  const sqrtRatio = SWUFpSqrtRatio2(Fp2, Z);
  if (!Fp2.isOdd)
...
function ecdsa(Point2, hash3, ecdsaOpts = {}) {
  ...
  class Signature {
    ...
    static fromCompact(hex3) {
      return Signature.fromBytes(ensureBytes2("sig", hex3), "compact");
    }
    static fromDER(hex3) {
      return Signature.fromBytes(ensureBytes2("sig", hex3), "der");
    }
    normalizeS() {
...
function normDST(DST) {
  if (!isBytes3(DST) && typeof DST !== "string")
    throw new Error("DST must be Uint8Array or string");
  return typeof DST === "string" ? utf8ToBytes5(DST) : DST;
}
...
function hash_to_field2(msg, count, options) {
  ...
  const { p, k, m, hash: hash3, expand: expand2, DST } = options;
...
function schnorrSign2(message, secretKey, auxRand = randomBytes3(32)) {
  ...
  const t = Fn.toBytes(d4 ^ num(taggedHash2("BIP0340/aux", a)));
...
var normalizeDataURL = (urlString, { stripHash }) => {
  ...
  const type = ((_a25 = match.groups) == null ? void 0 : _a25.type) ?? "";
...
var NDKRelayConnectivity = class {
  constructor(ndkRelay, ndk) {
    ...
    __publicField(this, "wsStateMonitor");
    __publicField(this, "sleepDetector");
    __publicField(this, "lastSleepCheck", Date.now());
    __publicField(this, "lastMessageSent", Date.now());
    __publicField(this, "wasIdle", false);
    /**
          ...
          const messageHandler = (e) => {
            ...
            try {
              ...
              if (data[0] === "EOSE" || data[0] === "EVENT" || data[0] === "NOTICE") {
                handler();
                (_a26 = this.ws) == null ? void 0 : _a26.removeEventListener("message", messageHandler);
              }
            } catch {
            }
          };
          (_a25 = this.ws) == null ? void 0 : _a25.addEventListener("message", messageHandler);
        }
      });
      if (!isAlive) {
  ...
  disconnect() {
    var _a25, _b;
    this._status = 0;
    (_a25 = this.keepalive) == null ? void 0 : _a25.stop();
  ...
  onConnect() {
    var _a25, _b;
    (_a25 = this.netDebug) == null ? void 0 : _a25.call(this, "connected", this.ndkRelay);
    if (this.reconnectTimeout) {
      clearTimeout(this.reconnectTimeout);
      this.reconnectTimeout = void 0;
    }
    ...
    this._status = 5;
    (_b = this.keepalive) == null ? void 0 : _b.start();
    this.wasIdle = false;
  ...
  onDisconnect() {
    var _a25, _b;
    (_a25 = this.netDebug) == null ? void 0 : _a25.call(this, "disconnected", this.ndkRelay);
    this.updateConnectionStats.disconnected();
    (_b = this.keepalive) == null ? void 0 : _b.stop();
    if (this._status === 5) {
      this.handleReconnection();
    }
    this._status = 1;
  ...
  onMessage(event) {
    var _a25, _b;
    (_a25 = this.netDebug) == null ? void 0 : _a25.call(this, event.data, this.ndkRelay, "recv");
    (_b = this.keepalive) == null ? void 0 : _b.recordActivity();
    try {
  ...
  async onAuthRequested(challenge3) {
    var _a25, _b, _c;
    const authPolicy = this.ndkRelay.authPolicy ?? ((_a25 = this.ndk) == null ? void 0 : _a25.relayAuthDefaultPolicy);
  ...
  async send(message) {
    ...
    if (this._status >= 5 && ((_a25 = this.ws) == null ? void 0 : _a25.readyState) === WebSocket.OPEN) {
      ...
      if (this._status >= 5 && ((_d = this.ws) == null ? void 0 : _d.readyState) !== WebSocket.OPEN) {
        this.debug(`Stale connection detected, WebSocket state: ${(_e = this.ws) == null ? void 0 : _e.readyState}`);
        this.handleStaleConnection();
      }
    }
  }
  ...
  get connected() {
    var _a25;
    return this._status >= 5 && ((_a25 = this.ws) == null ? void 0 : _a25.readyState) === WebSocket.OPEN;
  }
};
...
var SignatureVerificationStats = class {
  ...
  ${relayStat.url} ${relayStat.connected ? "(connected)" : "(disconnected)"}`);
        ...
        console.log(
          `    Target Validation Ratio: ${((_a25 = relayStat.targetValidationRatio) == null ? void 0 : _a25.toFixed(4)) || "N/A"} (${relayStat.targetValidationRatio ? (relayStat.targetValidationRatio * 100).toFixed(2) + "%" : "N/A"})`
        );
  ...
  collectStats() {
    ...
    return {
      ...
      blacklistedRelayCount: ((_a25 = this.ndk.blacklistRelayUrls) == null ? void 0 : _a25.length) || 0
    };
  }
};
...
var _a;
var NDKRelay = (_a = class extends EventEmitter {
  constructor(url, authPolicy, ndk) {
    ...
    this.validationRatioFn = ((ndk == null ? void 0 : ndk.validationRatioFn) ?? _a.defaultValidationRatioUpdateFn).bind(this);
...
}, __publicField(_a, "defaultValidationRatioUpdateFn", (relay, validatedCount, _nonValidatedCount) => {
    ...
    try {
      ...
      if (publishedToRelays.size < requiredRelayCount) {
        if (!isEphemeral2) {
          ...
          (_a25 = this.ndk) == null ? void 0 : _a25.emit("event:publish-failed", event, error, this.relayUrls);
          throw error;
        }
      } else {
...
async function calculateRelaySetFromEvent(ndk, event, requiredRelayCount) {
  ...
  if (authorWriteRelays) {
    authorWriteRelays.forEach((relayUrl) => {
      var _a26;
      const relay = (_a26 = ndk.pool) == null ? void 0 : _a26.getRelay(relayUrl);
  ...
  relayHints.forEach((relayUrl) => {
    var _a26;
    const relay = (_a26 = ndk.pool) == null ? void 0 : _a26.getRelay(relayUrl, true, true);
    if (relay) {
  ...
  if (pTags.length < 5) {
    ...
    pTaggedRelays.forEach((relayUrl) => {
      var _a26;
      const relay = (_a26 = ndk.pool) == null ? void 0 : _a26.getRelay(relayUrl, false, true);
      if (relay) {
  ...
  (_a25 = ndk.pool) == null ? void 0 : _a25.permanentAndConnectedRelays().forEach((relay) => relays.add(relay));
  if (requiredRelayCount && relays.size < requiredRelayCount) {
    ...
    explicitRelays == null ? void 0 : explicitRelays.forEach((url) => {
      var _a26;
      const relay = (_a26 = ndk.pool) == null ? void 0 : _a26.getRelay(url, false, true);
      if (relay) {
...
async function generateContentTags(content, tags = [], opts, ctx) {
  var _a25, _b;
  if (opts == null ? void 0 : opts.skipContentTagging) {
    return { content, tags };
  }
  ...
  content = content.replace(tagRegex, (tag) => {
    ...
    try {
      ...
      let t;
      if (opts == null ? void 0 : opts.filters) {
        const shouldInclude = !opts.filters.includeTypes || opts.filters.includeTypes.includes(type);
        const shouldExclude = (_a26 = opts.filters.excludeTypes) == null ? void 0 : _a26.includes(type);
      ...
      switch (type) {
        case "npub":
          if ((opts == null ? void 0 : opts.pTags) !== false) {
            t = ["p", data];
          }
          break;
        case "nprofile":
        ...
        case "nevent":
          promises.push(
            new Promise(async (resolve) => {
              ...
              if (author && (opts == null ? void 0 : opts.pTags) !== false && (opts == null ? void 0 : opts.pTagOnQTags) !== false) addTagIfNew(["p", author]);
              resolve();
            })
          );
          break;
        case "naddr":
          promises.push(
            new Promise(async (resolve) => {
              ...
              addTagIfNew(["q", id, relays[0]]);
              if ((opts == null ? void 0 : opts.pTags) !== false && (opts == null ? void 0 : opts.pTagOnQTags) !== false && (opts == null ? void 0 : opts.pTagOnATags) !== false) addTagIfNew(["p", data.pubkey]);
              resolve();
            })
          );
          break;
  ...
  await Promise.all(promises);
  if (!((_b = (_a25 = opts == null ? void 0 : opts.filters) == null ? void 0 : _a25.excludeTypes) == null ? void 0 : _b.includes("hashtag"))) {
    const newTags = generateHashtags(content).map((hashtag) => ["t", hashtag]);
    tags = mergeTags(tags, newTags);
  }
  if ((opts == null ? void 0 : opts.pTags) !== false && (opts == null ? void 0 : opts.copyPTagsFromTarget) && ctx) {
...
async function decrypt3(sender, signer, scheme) {
  var _a25, _b, _c, _d;
  if ((_b = (_a25 = this.ndk) == null ? void 0 : _a25.cacheAdapter) == null ? void 0 : _b.getDecryptedEvent) {
...
function verifySignature(persist) {
  ...
  try {
    if ((_a25 = this.ndk) == null ? void 0 : _a25.asyncSigVerification) {
      verifySignatureAsync(this, persist, this.relay).then((result) => {
        ...
        if (!result) {
          if (this.relay) {
            (_a26 = this.ndk) == null ? void 0 : _a26.reportInvalidSignature(this, this.relay);
          } else {
...
var NDKEvent = class _NDKEvent extends EventEmitter {
  constructor(ndk, event) {
    ...
    if (event instanceof _NDKEvent) {
      if (this.relay) {
        ...
        (_a25 = this.ndk) == null ? void 0 : _a25.subManager.seenEvent(event.id, this.relay);
      }
  ...
  set author(user) {
    ...
    this._author = user;
    (_a25 = this._author).ndk ?? (_a25.ndk = this.ndk);
  }
  /**
  ...
  tag(target, marker, skipAuthorTag, forceTag, opts) {
    ...
    if (isNDKUser) {
      forceTag ?? (forceTag = "p");
      if (forceTag === "p" && (opts == null ? void 0 : opts.pTags) === false) {
        return;
      }
  ...
  async toNostrEvent(pubkey, opts) {
    ...
    if (!pubkey && this.pubkey === "") {
      const user = await ((_b = (_a25 = this.ndk) == null ? void 0 : _a25.signer) == null ? void 0 : _b.user());
  ...
  async sign(signer, opts) {
    var _a25, _b;
    if (!signer) {
      (_a25 = this.ndk) == null ? void 0 : _a25.assertSigner();
  ...
  async publish(relaySet, timeoutMs, requiredRelayCount, opts) {
    ...
    if (this.kind === 5 && ((_a25 = this.ndk.cacheAdapter) == null ? void 0 : _a25.deleteEventIds)) {
    ...
    relays.forEach((relay) => {
      var _a26;
      return (_a26 = this.ndk) == null ? void 0 : _a26.subManager.seenEvent(this.id, relay);
    });
    return relays;
  }
  /**
  ...
  async generateTags(opts) {
    ...
    if (this.shouldAddClientTag) {
      const clientTag = ["client", ((_a25 = this.ndk) == null ? void 0 : _a25.clientName) ?? ""];
  ...
  get shouldAddClientTag() {
    var _a25, _b;
    if (!((_a25 = this.ndk) == null ? void 0 : _a25.clientName) && !((_b = this.ndk) == null ? void 0 : _b.clientNip89)) return false;
  ...
  muted() {
    var _a25, _b;
    const authorMutedEntry = (_a25 = this.ndk) == null ? void 0 : _a25.mutedIds.get(this.pubkey);
  ...
  referenceTags(marker, skipAuthorTag, forceTag, opts) {
    ...
    tags = tags.map((tag) => {
      var _a25, _b, _c;
      if (tag[0] === "e" || marker) {
        tag.push(((_a25 = this.relay) == null ? void 0 : _a25.url) ?? "");
    ...
    if (!skipAuthorTag && (opts == null ? void 0 : opts.pTags) !== false) tags.push(...this.author.referenceTags());
    return tags;
  }
  /**
  ...
  async delete(reason, publish = true) {
    ...
    e.tags.push(["k", (_a25 = this.kind) == null ? void 0 : _a25.toString()]);
    if (publish) {
      this.emit("deleted");
      await e.publish();
    }
  ...
  reply(forceNip22, opts) {
    ...
    if (this.kind === 1 && !forceNip22) {
      ...
      if (rootTags.length > 0) {
        ...
        if (this.isParamReplaceable()) {
          tag = ["a", this.tagAddress()];
          const relayHint = ((_a25 = this.relay) == null ? void 0 : _a25.url) ?? "";
          if (relayHint) tag.push(relayHint);
        } else {
          tag = ["e", this.tagId()];
          const relayHint = ((_b = this.relay) == null ? void 0 : _b.url) ?? "";
          tag.push(relayHint);
          tag.push(this.pubkey);
        }
        reply.tags.push(tag);
        ...
        let lowerTag;
        let upperTag;
        const relayHint = ((_c = this.relay) == null ? void 0 : _c.url) ?? "";
        if (this.isParamReplaceable()) {
        ...
        reply.tags.push(["K", (_d = this.kind) == null ? void 0 : _d.toString()]);
        if ((opts == null ? void 0 : opts.pTags) !== false && (opts == null ? void 0 : opts.pTagOnATags) !== false) {
          reply.tags.push(["P", this.pubkey]);
        }
      }
      reply.tags.push(["k", (_e = this.kind) == null ? void 0 : _e.toString()]);
      if ((opts == null ? void 0 : opts.pTags) !== false) {
...
var NDKPool = class extends EventEmitter {
  /**
  ...
  constructor(relayUrls, blacklistedRelayUrls, ndk, {
    ...
    __publicField(this, "disconnectionTimes", /* @__PURE__ */ new Map());
    __publicField(this, "systemEventDetector");
  ...
  useTemporaryRelay(relay, removeIfUnusedAfter = 3e4, filters) {
    ...
    if (!relayAlreadyInPool || existingTimer) {
      const timer = setTimeout(() => {
        var _a25;
        if ((_a25 = this.ndk.explicitRelayUrls) == null ? void 0 : _a25.includes(relay.url)) return;
  ...
  addRelay(relay, connect = true) {
    ...
    const isBlacklisted = (_a25 = this.blacklistRelayUrls) == null ? void 0 : _a25.has(relay.url);
    ...
    relay.on("delayed-connect", (delay) => {
      var _a26;
      if ((_a26 = this.ndk.cacheAdapter) == null ? void 0 : _a26.updateRelayStatus) {
...
var _a2;
var NDKCashuMintList = (_a2 = class extends NDKEvent {
  constructor(ndk, event) {
    super(ndk, event);
  ...
  static from(event) {
    return new _a2(event.ndk, event);
  }
  set relays(urls) {
...
}, __publicField(_a2, "kind", 10019), __publicField(_a2, "kinds", [
  10019
  /* CashuMintList */
]), _a2);
var _a3;
var NDKArticle = (_a3 = class extends NDKEvent {
...
}, __publicField(_a3, "kind", 30023), __publicField(_a3, "kinds", [
  30023
  /* Article */
]), _a3);
...
var _a4;
var NDKCashuToken = (_a4 = class extends NDKEvent {
  constructor(ndk, event) {
    super(ndk, event);
  ...
  static async from(event) {
    const token = new _a4(event.ndk, event);
...
}, __publicField(_a4, "kind", 7375), __publicField(_a4, "kinds", [
  7375
  /* CashuToken */
]), _a4);
var _a5;
var NDKHighlight = (_a5 = class extends NDKEvent {
  constructor(ndk, rawEvent) {
    super(ndk, rawEvent);
  ...
  static from(event) {
    return new _a5(event.ndk, event);
  }
  get url() {
  ...
  get context() {
    var _a25;
    return ((_a25 = this.tags.find(([tag, _value]) => tag === "context")) == null ? void 0 : _a25[1]) ?? void 0;
  }
  /**
  ...
  async getArticle() {
    ...
    if (taggedBech32) {
      let a = await ((_a25 = this.ndk) == null ? void 0 : _a25.fetchEvent(taggedBech32));
      if (a) {
        if (a.kind === 30023) {
          a = NDKArticle.from(a);
        }
...
}, __publicField(_a5, "kind", 9802), __publicField(_a5, "kinds", [
  9802
  /* Highlight */
]), _a5);
...
var _a6;
var NDKImage = (_a6 = class extends NDKEvent {
  constructor(ndk, rawEvent) {
    super(ndk, rawEvent);
...
}, __publicField(_a6, "kind", 20), __publicField(_a6, "kinds", [
  20
  /* Image */
]), _a6);
var _a7;
var NDKList = (_a7 = class extends NDKEvent {
  constructor(ndk, rawEvent) {
    super(ndk, rawEvent);
  ...
  static from(ndkEvent) {
    return new _a7(ndkEvent.ndk, ndkEvent);
  }
  /**
...
var _a8;
var NDKNutzap = (_a8 = class extends NDKEvent {
  constructor(ndk, event) {
    super(ndk, event);
    __publicField(this, "debug");
    __publicField(this, "_proofs", []);
  ...
  static from(event) {
    const e = new _a8(event.ndk, event);
  ...
  get rawP2pk() {
    ...
    try {
      ...
      if (typeof payload === "object" && payload !== null && typeof ((_a25 = payload[1]) == null ? void 0 : _a25.data) === "string") {
        return payload[1].data;
      }
    } catch (e) {
...
}, __publicField(_a8, "kind", 9321), __publicField(_a8, "kinds", [_a8.kind]), _a8);
function proofP2pk(proof) {
  ...
  try {
    ...
    const isP2PKLocked = payload[0] === "P2PK" && ((_a25 = payload[1]) == null ? void 0 : _a25.data);
    if (isP2PKLocked) {
      return payload[1].data;
    }
  } catch (e) {
...
var _a9;
var NDKSimpleGroupMemberList = (_a9 = class extends NDKEvent {
  constructor(ndk, rawEvent) {
    super(ndk, rawEvent);
  ...
  static from(event) {
    return new _a9(event.ndk, event);
  }
  get members() {
...
}, __publicField(_a9, "kind", 39002), __publicField(_a9, "kinds", [
  39002
  /* GroupMembers */
]), _a9);
var _a10;
var NDKSimpleGroupMetadata = (_a10 = class extends NDKEvent {
  constructor(ndk, rawEvent) {
    super(ndk, rawEvent);
...
}, __publicField(_a10, "kind", 39e3), __publicField(_a10, "kinds", [
  39e3
  /* GroupMetadata */
]), _a10);
...
var _a11;
var NDKStorySticker = (_a11 = class {
  constructor(arg) {
  ...
  get style() {
    var _a25;
    return (_a25 = this.properties) == null ? void 0 : _a25.style;
  }
  set style(style) {
    var _a25;
    if (style) this.properties = { ...this.properties, style };
    else (_a25 = this.properties) == null ? true : delete _a25.style;
  }
  get rotation() {
    var _a25;
    return ((_a25 = this.properties) == null ? void 0 : _a25.rot) ? Number.parseFloat(this.properties.rot) : void 0;
  }
  set rotation(rotation) {
    ...
    if (rotation !== void 0) {
      ...
      (_a25 = this.properties) == null ? true : delete _a25.rot;
    }
  }
  /**
...
}, __publicField(_a11, "Text", "text"), __publicField(_a11, "Pubkey", "pubkey"), __publicField(_a11, "Event", "event"), __publicField(_a11, "Prompt", "prompt"), __publicField(_a11, "Countdown", "countdown"), _a11);
var _a12;
var NDKStory = (_a12 = class extends NDKEvent {
  constructor(ndk, rawEvent) {
    super(ndk, rawEvent);
   ...
   */
  static from(event) {
    return new _a12(event.ndk, event);
  }
  /**
...
}, __publicField(_a12, "kind", 23), __publicField(_a12, "kinds", [
  23
  /* Story */
]), _a12);
...
var _a13;
var NDKSubscriptionTier = (_a13 = class extends NDKArticle {
  constructor(ndk, rawEvent) {
...
}, __publicField(_a13, "kind", 37001), __publicField(_a13, "kinds", [
  37001
  /* SubscriptionTier */
]), _a13);
var _a14;
var NDKVideo = (_a14 = class extends NDKEvent {
  constructor() {
    super(...arguments);
    __publicField(this, "_imetas");
  }
   ...
   */
  static from(event) {
    return new _a14(event.ndk, event.rawEvent());
  }
  /**
   * Getter for the article title.
   *
  ...
  get thumbnail() {
    ...
    if (this.imetas && this.imetas.length > 0) {
      thumbnail = (_a25 = this.imetas[0].image) == null ? void 0 : _a25[0];
    }
  ...
  async generateTags() {
    ...
    super.generateTags();
    if (!this.kind) {
      if ((_b = (_a25 = this.imetas) == null ? void 0 : _a25[0]) == null ? void 0 : _b.dim) {
...
}, __publicField(_a14, "kind", 21), __publicField(_a14, "kinds", [
  34235,
  34236,
  22,
  21
...
var _a15;
var NDKWiki = (_a15 = class extends NDKArticle {
  static from(event) {
...
}, __publicField(_a15, "kind", 30818), __publicField(_a15, "kinds", [
  30818
  /* Wiki */
]), _a15);
var _a16;
var NDKWikiMergeRequest = (_a16 = class extends NDKEvent {
  static from(event) {
...
}, __publicField(_a16, "kind", 818), __publicField(_a16, "kinds", [
  818
  /* WikiMergeRequest */
]), _a16);
var _a17;
var NDKBlossomList = (_a17 = class extends NDKEvent {
  constructor(ndk, rawEvent) {
    super(ndk, rawEvent);
    this.kind ?? (this.kind = 10063);
  }
  static from(ndkEvent) {
    return new _a17(ndkEvent.ndk, ndkEvent.rawEvent());
  }
  /**
...
}, __publicField(_a17, "kinds", [
  10063
  /* BlossomList */
]), _a17);
var _a18;
var NDKFollowPack = (_a18 = class extends NDKEvent {
  constructor(ndk, rawEvent) {
    super(ndk, rawEvent);
   ...
   */
  static from(ndkEvent) {
    return new _a18(ndkEvent.ndk, ndkEvent);
  }
  /**
...
}, __publicField(_a18, "kind", 39089), __publicField(_a18, "kinds", [
  39089,
  39092
  /* MediaFollowPack */
]), _a18);
...
var _a19;
var NDKProject = (_a19 = class extends NDKEvent {
  constructor(ndk, rawEvent) {
    super(ndk, rawEvent);
  ...
  static from(event) {
    return new _a19(event.ndk, event.rawEvent());
  }
  set repo(value) {
    this.removeTag("repo");
  ...
  async getSigner() {
    ...
    if (!encryptedKey) {
      ...
      const decryptedKey = await ((_b = (_a25 = this.ndk) == null ? void 0 : _a25.signer) == null ? void 0 : _b.decrypt(this.ndk.activeUser, encryptedKey));
      if (!decryptedKey) {
  ...
  async encryptAndSaveNsec() {
    ...
    const encryptedKey = await ((_b = (_a25 = this.ndk) == null ? void 0 : _a25.signer) == null ? void 0 : _b.encrypt(this.ndk.activeUser, key));
    if (encryptedKey) {
      this.removeTag("key");
      this.tags.push(["key", encryptedKey]);
    }
  }
}, __publicField(_a19, "kind", 31933), __publicField(_a19, "kinds", [_a19.kind]), _a19);
var _a20;
var NDKThread = (_a20 = class extends NDKEvent {
  constructor(ndk, rawEvent) {
    super(ndk, rawEvent);
    this.kind ?? (this.kind = 11);
  }
  /**
...
}, __publicField(_a20, "kind", 11), __publicField(_a20, "kinds", [
  11
  /* Thread */
]), _a20);
var _a21;
var NDKDraft = (_a21 = class extends NDKEvent {
  constructor(ndk, rawEvent) {
    super(ndk, rawEvent);
  ...
  static from(event) {
    return new _a21(event.ndk, event);
  }
  /**
  ...
  async getEvent(signer) {
    ...
    signer ?? (signer = (_a25 = this.ndk) == null ? void 0 : _a25.signer);
...
}, __publicField(_a21, "kind", 31234), __publicField(_a21, "kinds", [
  31234,
  1234
  /* DraftCheckpoint */
]), _a21);
var _a22;
var NDKTask = (_a22 = class extends NDKEvent {
  constructor(ndk, rawEvent) {
    super(ndk, rawEvent);
    this.kind = 1934;
  }
  static from(event) {
    return new _a22(event.ndk, event.rawEvent());
  }
  set title(value) {
    this.removeTag("title");
    if (value) this.tags.push(["title", value]);
  ...
  get projectSlug() {
    ...
    return tag ? (_a25 = tag[1].split(/:/)) == null ? void 0 : _a25[2] : void 0;
  }
}, __publicField(_a22, "kind", 1934), __publicField(_a22, "kinds", [1934]), _a22);
var _a23;
var NDKProjectTemplate = (_a23 = class extends NDKEvent {
  constructor(ndk, rawEvent) {
    super(ndk, rawEvent);
    this.kind = 30717;
  }
  static from(event) {
    return new _a23(event.ndk, event.rawEvent());
  }
  /**
...
}, __publicField(_a23, "kind", 30717), __publicField(_a23, "kinds", [30717]), _a23);
  ...
  if (subIds.length > 0) {
    ...
    for (const filter of filters) {
      for (const key of Object.keys(filter)) {
        if (key === "kinds") {
          (_a25 = filter.kinds) == null ? void 0 : _a25.forEach((k) => filterKinds.add(k));
        } else {
...
var NDKSubscription = class extends EventEmitter {
  ...
  relaysMissingEose() {
    ...
    const relaysMissingEose = Array.from((_a25 = this.relayFilters) == null ? void 0 : _a25.keys()).filter(
  ...
  get groupableDelay() {
    ...
    return (_a25 = this.opts) == null ? void 0 : _a25.groupableDelay;
  }
  get groupableDelayType() {
    var _a25;
    return ((_a25 = this.opts) == null ? void 0 : _a25.groupableDelayType) || "at-most";
  }
  isGroupable() {
    var _a25;
    return ((_a25 = this.opts) == null ? void 0 : _a25.groupable) || false;
  }
  shouldQueryCache() {
    var _a25;
    if (this.opts.addSinceFromCache) return true;
    if (((_a25 = this.opts) == null ? void 0 : _a25.cacheUsage) === "ONLY_RELAY") return false;
    const hasNonEphemeralKind = this.filters.some((f) => {
      var _a26;
      return (_a26 = f.kinds) == null ? void 0 : _a26.some((k) => kindIsEphemeral(k));
    });
  ...
  shouldQueryRelays() {
    var _a25;
    return ((_a25 = this.opts) == null ? void 0 : _a25.cacheUsage) !== "ONLY_CACHE";
  }
  shouldWaitForCache() {
    var _a25;
    if (this.opts.addSinceFromCache) return true;
    return (
      ...
      !!((_a25 = this.ndk.cacheAdapter) == null ? void 0 : _a25.locking) && // If explicitly told to run in parallel, then
  ...
  startPoolMonitor() {
    ...
    this.poolMonitor = (relay) => {
      var _a25, _b;
      if ((_a25 = this.relayFilters) == null ? void 0 : _a25.has(relay.url)) return;
  ...
  stop() {
    ...
    (_a25 = this.onStopped) == null ? void 0 : _a25.call(this);
  }
  /**
  ...
  hasAuthorsFilter() {
    return this.filters.some((f) => {
      var _a25;
      return (_a25 = f.authors) == null ? void 0 : _a25.length;
    });
  }
  startWithCache() {
    var _a25;
    if ((_a25 = this.ndk.cacheAdapter) == null ? void 0 : _a25.query) {
  ...
  eventReceived(event, relay, fromCache = false, optimisticPublish = false) {
    ...
    if (!eventAlreadySeen) {
      ...
      if (!optimisticPublish || this.skipOptimisticPublishEvent !== true) {
        this.emitEvent(((_a25 = this.opts) == null ? void 0 : _a25.wrap) ?? false, ndkEvent, relay, fromCache, optimisticPublish);
  ...
  eoseReceived(relay) {
    ...
    const hasSeenAllEoses = this.eosesSeen.size === ((_a25 = this.relayFilters) == null ? void 0 : _a25.size);
    ...
    const performEose = (reason) => {
      ...
      this.emit("eose", this);
      this.eosed = true;
      if ((_a26 = this.opts) == null ? void 0 : _a26.closeOnEose) this.stop();
    };
...
async function follows(opts, outbox, kind = 3) {
  ...
  if (contactListEvent) {
    ...
    if (outbox) {
      (_b = (_a25 = this.ndk) == null ? void 0 : _a25.outboxTracker) == null ? void 0 : _b.trackUsers(Array.from(pubkeys));
    }
...
async function getNip05For(ndk, fullname, _fetch5 = fetch, fetchOpts = {}) {
  return await ndk.queuesNip05.add({
    ...
    func: async () => {
      var _a25, _b, _c;
      if ((_a25 = ndk.cacheAdapter) == null ? void 0 : _a25.loadNip05) {
...
var NDKUser = class _NDKUser {
  ...
  get nprofile() {
    var _a25, _b;
    const relays = (_b = (_a25 = this.profileEvent) == null ? void 0 : _a25.onRelays) == null ? void 0 : _b.map((r) => r.url);
...
var _a24;
var NDKCashuWalletTx = (_a24 = class extends NDKEvent {
  constructor(ndk, event) {
    super(ndk, event);
    this.kind ?? (this.kind = 7376);
  }
  static async from(event) {
    const walletChange = new _a24(event.ndk, event);
...
}, __publicField(_a24, "MARKERS", MARKERS), __publicField(_a24, "kind", 7376), __publicField(_a24, "kinds", [
  7376
  /* CashuWalletTx */
]), _a24);
  ...
  get relaySet() {
    ...
    return new NDKRelaySet(
      new Set(this.relays.map((u) => {
        var _a25;
        return (_a25 = this.ndk) == null ? void 0 : _a25.pool.getRelay(u);
      }).filter((r) => !!r)),
      this.ndk
    );
  }
...
var NDKSubscriptionReceipt = class _NDKSubscriptionReceipt extends NDKEvent {
  ...
  get recipient() {
    var _a25;
    const pTag = (_a25 = this.getMatchingTags("p")) == null ? void 0 : _a25[0];
  ...
  get tierName() {
    var _a25;
    const tag = (_a25 = this.getMatchingTags("tier")) == null ? void 0 : _a25[0];
  ...
  get validPeriod() {
    var _a25;
    const tag = (_a25 = this.getMatchingTags("valid")) == null ? void 0 : _a25[0];
  ...
  get startPeriod() {
    var _a25;
    return (_a25 = this.validPeriod) == null ? void 0 : _a25.start;
  }
  get endPeriod() {
    var _a25;
    return (_a25 = this.validPeriod) == null ? void 0 : _a25.end;
  }
  /**
...
var NDKSubscriptionStart = class _NDKSubscriptionStart extends NDKEvent {
  ...
  get amount() {
    var _a25;
    const amountTag = (_a25 = this.getMatchingTags("amount")) == null ? void 0 : _a25[0];
  ...
  get tierId() {
    var _a25, _b;
    const eTag = (_a25 = this.getMatchingTags("e")) == null ? void 0 : _a25[0];
  ...
  async fetchTier() {
    ...
    const e = await ((_a25 = this.ndk) == null ? void 0 : _a25.fetchEvent(tierId));
    if (!e) return void 0;
...
var NDKSimpleGroup = class _NDKSimpleGroup {
  ...
  relayUrls() {
    var _a25;
    return (_a25 = this.relaySet) == null ? void 0 : _a25.relayUrls;
  }
  get name() {
    var _a25;
    return (_a25 = this.metadata) == null ? void 0 : _a25.name;
  }
  get about() {
    var _a25;
    return (_a25 = this.metadata) == null ? void 0 : _a25.about;
  }
  get picture() {
    var _a25;
    return (_a25 = this.metadata) == null ? void 0 : _a25.picture;
  }
  get members() {
    var _a25;
    return ((_a25 = this.memberList) == null ? void 0 : _a25.members) ?? [];
  }
  get admins() {
    var _a25;
    return ((_a25 = this.adminList) == null ? void 0 : _a25.members) ?? [];
  }
  async getMetadata() {
...
var NDKNip07Signer = class _NDKNip07Signer {
  ...
  async blockUntilReady() {
    ...
    const pubkey = await ((_a25 = window.nostr) == null ? void 0 : _a25.getPublicKey());
    if (!pubkey) {
  ...
  async sign(event) {
    var _a25;
    await this.waitForExtension();
    const signedEvent = await ((_a25 = window.nostr) == null ? void 0 : _a25.signEvent(event));
  ...
  async relays(ndk) {
    var _a25, _b;
    await this.waitForExtension();
    const relays = await ((_b = (_a25 = window.nostr) == null ? void 0 : _a25.getRelays) == null ? void 0 : _b.call(_a25)) || {};
    const activeRelays = [];
  ...
  async encryptionEnabled(nip) {
    var _a25, _b;
    const enabled = [];
    if ((!nip || nip === "nip04") && Boolean((_a25 = window.nostr) == null ? void 0 : _a25.nip04)) enabled.push("nip04");
  ...
  async processEncryptionQueue(item, retries = 0) {
    ...
    try {
      const result = await ((_b = (_a25 = window.nostr) == null ? void 0 : _a25[scheme]) == null ? void 0 : _b[method](counterpartyHexpubkey, value));
...
var NDKNostrRpc = class extends EventEmitter {
...
var GetPublicKeyHandlingStrategy = class {
  async handle(backend, _id, _remotePubkey, _params) {
    var _a25;
    return (_a25 = backend.localUser) == null ? void 0 : _a25.pubkey;
  }
};
...
var NDKNip46Signer = class _NDKNip46Signer extends EventEmitter {
  /**
   *
  ...
  nostrconnectFlowInit(nostrConnectOptions) {
    ...
    this.nostrConnectUri = generateNostrConnectUri(
      ...
      (_a25 = this.relayUrls) == null ? void 0 : _a25[0],
      nostrConnectOptions
    );
  }
  ...
  stop() {
    var _a25;
    (_a25 = this.subscription) == null ? void 0 : _a25.stop();
...
function addRelays(event, relays) {
  ...
  const tags = [];
  if (!relays || relays.length === 0) {
    const poolRelays = (_a25 = event.ndk) == null ? void 0 : _a25.pool.relays;
...
async function getRelayListForUsers(pubkeys, ndk, skipCache = false, timeout = 1e3) {
  ...
  if (((_a25 = ndk.cacheAdapter) == null ? void 0 : _a25.locking) && !skipCache) {
...
var OutboxTracker = class extends EventEmitter {
  constructor(ndk) {
    super();
...
async function setActiveUserConnected(user) {
  ...
  if (this.autoFetchUserMutelist) {
    (_a25 = filters[0].kinds) == null ? void 0 : _a25.push(1e4);
  }
...
var NDK = class extends EventEmitter {
  constructor(opts = {}) {
    super();
  ...
  addExplicitRelay(urlOrRelay, relayAuthPolicy, connect = true) {
    ...
    (_a25 = this.explicitRelayUrls) == null ? void 0 : _a25.push(relay.url);
    return relay;
  }
  toJSON() {
  ...
  set activeUser(user) {
    var _a25;
    const differentUser = ((_a25 = this._activeUser) == null ? void 0 : _a25.pubkey) !== (user == null ? void 0 : user.pubkey);
  ...
  async connect(timeoutMs) {
    ...
    if (this._signer && this.autoConnectUserRelays) {
      this.debug(
        ...
        await ((_b = (_a25 = this._signer).relays) == null ? void 0 : _b.call(_a25, this))
      );
  ...
  subscribe(filters, opts, autoStartOrRelaySet = true, _autoStart = true) {
    ...
    if (this.outboxPool && subscription.hasAuthorsFilter()) {
      const authors = subscription.filters.filter((filter) => {
        var _a26;
        return filter.authors && ((_a26 = filter.authors) == null ? void 0 : _a26.length) > 0;
      }).flatMap((filter) => filter.authors);
      (_a25 = this.outboxTracker) == null ? void 0 : _a25.trackUsers(authors);
    }
    if (autoStart) {
      let eventsHandler;
  ...
  set wallet(wallet) {
    ...
    this.walletConfig.lnPay = (_a25 = wallet == null ? void 0 : wallet.lnPay) == null ? void 0 : _a25.bind(wallet);
...
var NDKZapper = class extends EventEmitter {
  /**
   *
  ...
  constructor(target, amount, unit = "msat", opts = {}) {
    ...
    this.lnPay = opts.lnPay || ((_a25 = this.ndk.walletConfig) == null ? void 0 : _a25.lnPay);
  ...
  async zapSplit(split2, methods) {
    ...
    const nip61Fallback = async () => {
      ...
      let relayUrls = (_a25 = relayLists.get(split2.pubkey)) == null ? void 0 : _a25.readRelayUrls;
  ...
  async relays(pubkey) {
    var _a25, _b, _c;
    let r = [];
    if ((_a25 = this.ndk) == null ? void 0 : _a25.activeUser) {
...
function matchFilter2(filter, event) {
  ...
  for (const f in filter) {
    if (f[0] === "#") {
      ...
      if (tagName === "t") {
        const values = (_a25 = filter[`#${tagName}`]) == null ? void 0 : _a25.map((v) => v.toLowerCase());
