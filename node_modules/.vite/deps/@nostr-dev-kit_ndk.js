...
import {
  ...
  nip44_exports,
  nip57_exports
} from "./chunk-3GNR72HT.js";
import "./chunk-I7BVD2AW.js";
import "./chunk-WJ7H4NOH.js";
import "./chunk-Q4BATYZK.js";
import "./chunk-U4QT6ODW.js";
import "./chunk-64DLGFH7.js";
import {
  __commonJS,
  __publicField,
  __toESM
...
// src/shims/tseep.ts
var cloneListeners = (listeners) => listeners ? listeners.slice() : [];
var unwrapListener = (listener) => listener.__originalListener__ ?? listener;
var EventEmitter = class {
  constructor() {
    __publicField(this, "listenersByEvent", /* @__PURE__ */ new Map());
  ...
  listenerCount(event) {
    var _a25;
    return ((_a25 = this.listenersByEvent.get(event)) == null ? void 0 : _a25.length) ?? 0;
  }
  addListener(event, listener) {
    return this.addInternal(event, listener, false);
  }
  on(event, listener) {
  ...
  prependListener(event, listener) {
    return this.addInternal(event, listener, true);
  }
  ...
  addInternal(event, listener, prepend) {
    const listeners = this.listenersByEvent.get(event) ?? [];
    if (prepend) {
