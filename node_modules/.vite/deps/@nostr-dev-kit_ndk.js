import {
  ...
  nip44_exports,
  nip57_exports
} from "./chunk-47OZM2EK.js";
import {
  require_browser
} from "./chunk-VYR6M4Y6.js";
import {
  __commonJS,
  __publicField,
  __toESM
} from "./chunk-M3OZU7QV.js";
...
var require_bolt11 = __commonJS({
  "node_modules/.pnpm/light-bolt11-decoder@3.2.0/node_modules/light-bolt11-decoder/bolt11.js"(exports, module) {
    var { bech32: bech322, hex: hex2, utf8 } = require_lib();
    var DEFAULTNETWORK = {
...
function verifySignature(persist) {
  ...
  try {
    if ((_a25 = this.ndk) == null ? void 0 : _a25.asyncSigVerification) {
      ...
      const hash = sha2562(new TextEncoder().encode(this.serialize()));
...
function getEventHashFromSerializedEvent(serializedEvent) {
  const eventHash = sha2562(new TextEncoder().encode(serializedEvent));
