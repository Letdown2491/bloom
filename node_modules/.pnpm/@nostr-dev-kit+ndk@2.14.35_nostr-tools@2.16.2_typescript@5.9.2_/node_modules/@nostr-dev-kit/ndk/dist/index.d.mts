...
declare function generateContentTags(content: string, tags?: NDKTag[], opts?: ContentTaggingOptions, ctx?: NDKEvent): Promise<ContentTag>;
 ...
 * @group Kind Wrapper
 */
declare class NDKThread extends NDKEvent {
    static kind: NDKKind;
    static kinds: NDKKind[];
    constructor(ndk: NDK | undefined, rawEvent?: NostrEvent | NDKEvent);
    /**
     ...
     * @returns NDKThread
     */
    static from(event: NDKEvent): NDKThread;
    /**
